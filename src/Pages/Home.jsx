...
const Home = () => {
  return (
    <div className=" back-shape">
      <div className=" flex justify-between gap-10 items-center w-full h-full px-32">
        <div className="w-full space-y-5">
          <h1 className="text-9xl text-white/80 font-black">Ashraful Haque</h1>

          {/* type writer */}
          <div>
            <h1 className="text-4xl text-white/80 font-black">
              Passionate
          ...
          <div className="">
            <ul className=" flex justify-start items-center gap-6">
              {/* github */}
              <li className="text-3xl text-white bg-white/80 p-5 rounded-full hover:bg-white">
                <a
        ...
        <div className="w-full flex flex-col gap-9 justify-center items-center">
          <img
            ...
            alt=""
          />
          <p className="text-xl text-center text-white/80 font-black">
